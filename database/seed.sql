...
('sync_1', 'tenant_1', 'IN', 'ORDER', 'order_1', NULL, 'SUCCESS', '{}', '{}', NULL, 0, NOW());
...
('shipment_1', 'tenant_1', 'order_1', 'Carrier A', 'Service A', 'TRACK123', 'http://labelurl.com/label1', 'SHIPPED', 10.0, '{}', '2023-10-20', NOW(), NULL, NOW(), NOW());
...
('order_1', 'tenant_1', 'PURCHASE', 'ERP12345', 'CLOSED', '2023-10-22', 'Customer A', '{}', NULL, '{}', NOW(), 'SUCCESS', NOW(), NOW());
...
('movement_1', 'tenant_1', 'INCOMING', 'sku_1', NULL, 'loc_1', 'loc_2', 50, 'EA', 'ORDER', 'order_1', 'user_1', 'SUCCESS', 'Initial Stock', NOW());
...
('inventory_1', 'tenant_1', 'loc_1', 'sku_1', NULL, 100, 0, 100, 'EA', NULL, NOW(), NOW());
...
('lot_1', 'tenant_1', 'sku_1', 'LOT', 'LOT123', NULL, '2023-01-01', '2024-01-01', '2023-10-01', NULL, 'ACTIVE', 'USA', NOW(), NOW());
...
('sku_1', 'tenant_1', 'SKU001', 'SKU Name', 'Description of SKU', 'EA', '{}', TRUE, FALSE, FALSE, 30, 1.0, '{}', 'ERP001', NULL, TRUE, NOW(), NOW());
...
('loc_1', 'warehouse_1', NULL, 'LOC001', 'STORAGE', 'Storage Location 1', '/ROOT/LOC001', 500.0, 100.0, 'ACTIVE', TRUE, TRUE, NOW(), NOW());
...
('warehouse_1', 'tenant_1', 'WAREHOUSE001', 'Main Warehouse', '123 Main St', '', 'Cityville', 'State', '12345', 'US', 'UTC', TRUE, NOW(), NOW());

...
('log1', 'tenant1', 'IMPORT', 'ORDER', 'order1', 'erpRef1', 'SUCCESS', '{}', '{}', NULL, 0, NOW());
...
('shipment1', 'tenant1', 'order1', 'CarrierName', 'ServiceCode', 'tracking1', 'http://label.com/1', 'SHIPPED', 10.0, '{"length": 100, "width": 50, "height": 50}', '2023-12-01', NOW(), NULL, NOW(), NOW());
...
('order1', 'tenant1', 'PURCHASE', 'erpOrder1', 'PROCESSING', '2023-12-05', 'Supplier1', '{}', 'carrier1', '{}', NOW(), 'PENDING', NOW(), NOW());
...
('movement1', 'tenant1', 'IN', 'sku1', NULL, 'loc1', 'loc2', 20, 'KG', 'ORDER', 'order1', 'user1', 'SUCCESS', 'Restocking', NOW());
...
('inv1', 'tenant1', 'loc1', 'sku1', NULL, 50, 5, 45, 'KG', NOW(), NOW(), NOW());
...
('lot1', 'tenant1', 'sku1', 'LOT', 'lot001', 'serial001', '2023-01-01', '2024-01-01', NOW(), 'supplierLotRef1', 'AVAILABLE', 'USA', NOW(), NOW());
...
('sku1', 'tenant1', 'SKU001', 'SKU Name', 'SKU Description', 'KG', '{}', TRUE, FALSE, FALSE, 30, 5.0, '{}', 'erpSku1', NULL, TRUE, NOW(), NOW());
...
('loc1', 'warehouse1', NULL, 'Location1', 'PICKING', 'Location One', '/loc1', 1000, 100, 'ACTIVE', TRUE, TRUE, NOW(), NOW());
...
('warehouse1', 'tenant1', 'WH001', 'Warehouse One', 'Address Line 1', NULL, 'City Name', 'State', '12345', 'US', 'UTC', TRUE, NOW(), NOW());

INSERT INTO Role (role_id, tenant_id, role_name, permissions, description, is_system_role, created_at, updated_at) VALUES
('role1', 'tenant1', 'Admin', '{}', 'Administrator Role', TRUE, NOW(), NOW());
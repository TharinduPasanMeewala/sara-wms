...
CREATE TYPE sync_status_enum AS ENUM ('SUCCESS', 'FAILURE', 'PENDING');
CREATE TYPE shipment_status_enum AS ENUM ('PENDING', 'SHIPPED', 'DELIVERED', 'RETURNED');
CREATE TYPE order_type_enum AS ENUM ('STANDARD', 'EXPRESS', 'BULK');
...
CREATE TYPE location_type_enum AS ENUM ('STORAGE', 'PICKING', 'RECEIVING', 'SHIPPING');
CREATE TYPE location_status_enum AS ENUM ('ACTIVE', 'INACTIVE');
CREATE TYPE erp_sync_status_enum AS ENUM ('SYNCHED', 'NOT_SYNCHED');
...
CREATE TABLE "Order" (
    ...
    erp_sync_status erp_sync_status_enum NOT NULL,
    created_at TIMESTAMP NOT NULL,
    updated_at TIMESTAMP NOT NULL
);

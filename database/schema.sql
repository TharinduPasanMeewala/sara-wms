...
CREATE TYPE entity_type_enum AS ENUM ('ORDER', 'SHIPMENT', 'INVENTORY', 'STOCK_MOVEMENT');
CREATE TYPE sync_status_enum AS ENUM ('PENDING', 'COMPLETED', 'FAILED');
CREATE TYPE shipment_status_enum AS ENUM ('PENDING', 'SHIPPED', 'DELIVERED');
CREATE TYPE order_type_enum AS ENUM ('PURCHASE', 'SALE');
...
CREATE TYPE tracking_type_enum AS ENUM ('LOT_TRACKING', 'SERIAL_TRACKING');
CREATE TYPE lot_status_enum AS ENUM ('ACTIVE', 'EXPIRED', 'DELETED');
CREATE TYPE location_type_enum AS ENUM ('PICKING', 'RECEIVING', 'STORAGE');
CREATE TYPE location_status_enum AS ENUM ('ACTIVE', 'INACTIVE');
CREATE TYPE role_permissions_enum AS ENUM ('READ', 'WRITE', 'DELETE');

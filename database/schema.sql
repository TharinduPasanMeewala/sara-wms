...
CREATE TYPE entity_type AS ENUM ('ORDER', 'SHIPPING', 'INVENTORY', 'STOCK_MOVEMENT');
...
CREATE TYPE reference_type AS ENUM ('ORDER', 'SHIPPING');
CREATE TYPE tracking_type AS ENUM ('LOT', 'SERIAL');
CREATE TYPE lot_serial_status AS ENUM ('AVAILABLE', 'ALLOCATED', 'EXPIRED');
CREATE TYPE location_type AS ENUM ('PICKING', 'STORAGE', 'RECEIVING');
